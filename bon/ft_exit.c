...
int	exit_ft(t_game *game)
{
	...
	mlx_destroy_image(game->mlx, game->collect_img1);
	mlx_destroy_image(game->mlx, game->collect_img2);
	mlx_destroy_image(game->mlx, game->collect_img3);
	mlx_destroy_image(game->mlx, game->collect_img4);
	mlx_destroy_image(game->mlx, game->collect_img5);
	mlx_destroy_image(game->mlx, game->collect_img6);
	mlx_destroy_image(game->mlx, game->collect_img7);
